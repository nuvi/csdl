module CSDL
  ...
  module TargetValues
    ...
    REGIONS_BY_COUNTRY = {
      ...
      "Bulgaria" => [
        "Blagoevgrad" , "Burgas"       , "Dobrich"     , "Gabrovo" , "Grad Sofiya"    ,
        "Khaskovo"    , "Kurdzhali"    , "Kyustendil"  , "Lovech"  , "Montana"        ,
        "Pazardzhik"  , "Pernik"       , "Pleven"      , "Plovdiv" , "Razgrad"        ,
        "Ruse"        , "Shumen"       , "Silistra"    , "Sliven"  , "Smolyan"        ,
        "Sofiya"      , "Stara Zagora" , "Turgovishte" , "Varna"   , "Veliko Turnovo" ,
        "Vidin"       , "Vratsa"       , "Yambol"
      ].freeze,

      "Croatia" => [
        "Bjelovarsko-Bilogorska" , "Brodsko-Posavska"   , "Dubrovacko-Neretvanska" ,
        "Grad Zagreb"            , "Istarska"           , "Karlovacka"             ,
        "Koprivnicko-Krizevacka" , "Krapinsko-Zagorska" , "Medimurska"             ,
        "Osjecko-Baranjska"      , "Primorsko-Goranska" , "Sisacko-Moslavacka"     ,
        "Splitsko-Dalmatinska"   , "Varazdinska"        , "Viroviticko-Podravska"  ,
      ...
      "Czech Republic" => [
        "Hlavni Mesto Praha" , "Hradec Kralove" , "Jihocesky Kraj"       , "Jihomoravsky Kraj" ,
        "Karlovarsky Kraj"   , "Liberecky Kraj" , "Moravskoslezsky Kraj" , "Olomoucky Kraj"    ,
        "Pardubicky Kraj"    , "Plzensky Kraj"  , "Stredocesky Kraj"     , "Ustecky Kraj"      ,
      ...
      "Egypt" => [
        "Ad Daqahliyah"  , "Al Bahr al Ahmar" , "Al Buhayrah"     ,
        "Al Fayyum"      , "Al Gharbiyah"     , "Al Iskandariyah" ,
        "Al Isma'iliyah" , "Al Jizah"         , "Al Minufiyah"    ,
        "Al Minya"       , "Al Qahirah"       , "Al Qalyubiyah"   ,
        "As Suways"      , "Ash Sharqiyah"    , "Aswan"           ,
        "Asyut"          , "Bani Suwayf"      , "Bur Sa'id"       ,
        "Dumyat"         , "Janub Sina'"      , "Kafr ash Shaykh" ,
        "Matruh"         , "Qina"             , "Shamal Sina'"    ,
        "Suhaj"
      ].freeze,
      ...
      "Iraq" => [
        "Al Anbar"     , "Al Basrah" , "Al Muthanna"     , "Al Qadisiyah" ,
        "An Najaf"     , "Arbil"     , "As Sulaymaniyah" , "At Ta'mim"    ,
      ...
      "Israel" => [
        "HaDarom", "HaMerkaz", "HaTzafon", "Heifa", "Tel Aviv", "Yerushalayim"
      ].freeze,
      ...
      "Jordan" => [
        "Al Balqa'" , "Al Karak" , "Al Mafraq" , "Amman" , "At Tafilah" ,
        "Az Zarqa"  , "Irbid"    , "Ma"
      ].freeze,
      ...
      "Lebanon" => [
        "Beyrouth", "Liban-Nord", "Liban-Sud", "Mont-Liban"
      ].freeze,

      "Lithuania" => [
        "Kauno Apskritis", "Klaipedos Apskritis", "Panevezio Apskritis", "Siauliu Apskritis", "Vilniaus Apskritis"
      ].freeze,
      ...
      "Macedonia, the former Yugoslav Republic of" => [
        "Kumanovo" , "Ohrid" , "Prilep" , "Struga"   , "Strumica" ,
        "Tetovo"   , "Veles" , "Stip"   , "Gostivar"
      ].freeze,
      ...
      "Mauritius" => [
        "Flacq"      , "Grand Port"         , "Pamplemousses" , "Plaines Wilhems" ,
        "Port Louis" , "Riviere du Rempart"
      ].freeze,

      "Morocco" => [
        "Casablanca", "Fes", "Marrakech", "Meknes", "Rabat-Sale", "Tanger", "Taza"
      ].freeze,
      ...
      "Nigeria" => [
        "Abia"   , "Akwa Ibom" , "Anambra" , "Benue"                     , "Cross River" ,
        "Delta"  , "Edo"       , "Enugu"   , "Federal Capital Territory" , "Imo"         ,
        "Kaduna" , "Kano"      , "Kwara"   , "Lagos"                     , "Ogun"        ,
      ...
      "Poland" => [
        ...
        "Lubuskie"            , "Malopolskie"        , "Opolskie"           , "Podkarpackie"   ,
      ...
      "Saudi Arabia" => [
        "Al Jawf" , "Al Madinah" , "Al Qasim" , "Ar Riyad" , "Ash Sharqiyah" ,
        "Ha'il"   , "Jizan"      , "Makkah"   , "Tabuk"
      ].freeze,

      "Serbia" => [].freeze,

      "Slovakia" => [
        "Banska Bystrica" , "Bratislava" , "Kosice" , "Nitra" , "Presov" ,
      ...
      "Tunisia" => [
        ...
        "Bajah"       , "Banzart"      , "Bin"        , "Jundubah"    ,
        "Kef"         , "Madanin"      , "Nabul"      , "Qabis"       ,
        "Safaqis"     , "Sidi Bu Zayd" , "Susah"      , "Tunis"
      ].freeze,

      "Turkey" => [
        "Adana"     , "Adiyaman"      , "Afyonkarahisar" , "Ağrı"      , "Amasya"    ,
        "Ankara"    , "Antalya"       , "Artvin"         , "Aydin"     , "Balikesir" ,
        "Batman"    , "Bilecik"       , "Bingöl"         , "Bitlis"    , "Bolu"      ,
        "Burdur"    , "Bursa"         , "Çanakkale"      , "Cankiri"   , "Çorum"     ,
        "Denizli"   , "Diyarbakir"    , "Edirne"         , "Elazığ"    , "Erzincan"  ,
        "Erzurum"   , "Eskişehir"     , "Gaziantep"      , "Giresun"   , "Gumushane" ,
        "Hakkari"   , "Hatay"         , "Icel"           , "Isparta"   , "Istanbul"  ,
        "Izmir"     , "Kahramanmaraş" , "Karaman"        , "Kars"      , "Kastamonu" ,
        "Kayseri"   , "Kilis"         , "Kirklareli"     , "Kırşehir"  , "Kocaeli"   ,
        "Konya"     , "Kütahya"       , "Malatya"        , "Manisa"    , "Muğla"     ,
        "Muş"       , "Nevşehir"      , "Nigde"          , "Ordu"      , "Osmaniye"  ,
        "Rize"      , "Sakarya"       , "Samsun"         , "Şanlıurfa" , "Sinop"     ,
        "Sirnak"    , "Sivas"         , "Tekirdağ"       , "Tokat"     , "Trabzon"   ,
        "Tunceli"   , "Uşak"          , "Van"            , "Yalova"    , "Yozgat"    ,
        "Zonguldak" , "Ardahan"
      ].freeze,

      "Ukraine" => [
        "Dnipropetrovs'ka Oblast'" , "Donets'ka Oblast'"     , "Ivano-Frankivs'ka Oblast'" ,
        "Kharkivs'ka Oblast'"      , "Krym"                  , "Kyyivs'ka Oblast'"         ,
        "L'vivs'ka Oblast'"        , "Odes'ka Oblast'"       , "Vinnyts'ka Oblast'"        ,
        "Zakarpats'ka Oblast'"     , "Zaporiz'ka Oblast'"    , "Cherkas'ka Oblast'"        ,
        "Chernivets'ka Oblast'"    , "Mikolayivs'ka Oblast'" , "Poltavs'ka Oblast'"        ,
        "Rivnens'ka Oblast'"       , "Ternopil's'ka Oblast'" , "Volyns'ka Oblast'"
      ].freeze,
